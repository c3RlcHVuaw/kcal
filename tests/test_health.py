...
def test_webapp_shell_is_served() -> None:
    ...
    assert "/app/static/themes.css?v=ios26-v12-20260819" in response.text
    ...
    assert response.text.index("/app/static/styles.css") < response.text.index("/app/static/ios26.css")
