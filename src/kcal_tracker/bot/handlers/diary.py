...
from kcal_tracker.bot.handlers.diary_formatting import (
    activity_dashboard_text as _activity_dashboard_text,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    activity_line as _activity_line,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    activity_management_text as _activity_management_text,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    day_offset_date_label as _day_offset_date_label,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    day_offset_title as _day_offset_title,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    entries_by_meal as _entries_by_meal,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    entry_line as _entry_line,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    entry_time_label as _entry_time_label,  # noqa: F401 - compatibility re-export
)
from kcal_tracker.bot.handlers.diary_formatting import (
    meal_summary_lines as _meal_summary_lines,  # noqa: F401 - compatibility re-export
)
from kcal_tracker.bot.handlers.diary_formatting import (
    parse_favorite_payload as _parse_favorite_payload,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    parse_float as _parse_float,
)
from kcal_tracker.bot.handlers.diary_formatting import (
    parse_macros as _parse_macros,
)
from kcal_tracker.bot.handlers.diary_formatting import (
