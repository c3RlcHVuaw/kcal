...
class Settings(BaseSettings):
    ...
    ai_photo_queue_concurrency: int = Field(default=4, ge=1)
    ai_photo_queue_wait_seconds: float = Field(default=12.0, ge=0)
    ai_photo_queue_slot_ttl_seconds: int = Field(default=90, ge=10)
    ...
    admin_paywall_no_payment_start_hour_threshold: int = Field(default=8, ge=1)
    admin_unverified_packaged_hour_threshold: int = Field(default=5, ge=1)
